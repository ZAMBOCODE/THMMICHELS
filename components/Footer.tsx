    ...
    <footer className="py-10 md:py-14 bg-[#0F0F0F] border-t border-white/10">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
          ...
          <nav className="flex flex-wrap gap-x-6 gap-y-2 font-mono text-sm text-[#9CA3AF]">
            <Link to="/" className="hover:text-[#D97706] transition-colors">Startseite</Link>
            <Link to="/leistungen/event-container" className="hover:text-[#D97706] transition-colors">Leistungen</Link>
            <Link to="/galerie" className="hover:text-[#D97706] transition-colors">Galerie</Link>
            <Link to="/blog" className="hover:text-[#D97706] transition-colors">Blog</Link>
            <Link to="/kontakt" className="hover:text-[#D97706] transition-colors">Kontakt</Link>
          </nav>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8 pb-8 border-b border-white/5">
          <div className="font-mono text-sm text-[#9CA3AF] space-y-1">
            <a href="tel:+491702847337" className="hover:text-[#D97706] transition-colors block">+49 170 2847337</a>
            <a href="mailto:info@thm-michels.de" className="hover:text-[#D97706] transition-colors block">info@thm-michels.de</a>
          </div>
