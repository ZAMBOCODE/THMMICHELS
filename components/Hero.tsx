  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-30 max-w-7xl mx-auto px-6 text-center md:text-left">
        <div
          className={`inline-block px-4 py-1 border border-white/20 bg-white/5 backdrop-blur-sm mb-6 transition-all duration-1000 ease-out ${
        ...
        <h1
          className={`font-display font-black text-5xl md:text-8xl lg:text-9xl leading-none mb-8 uppercase tracking-tighter transition-all duration-1000 ease-out ${
            isLoaded ? 'opacity-100' : 'opacity-0'
          }`}
      ...
      {/* Blueprint Labels */}
      <div
        className={`absolute bottom-12 left-12 hidden lg:block z-30 font-mono text-[10px] transition-all duration-1000 ease-out ${
      ...
      <div
        className={`absolute bottom-12 right-12 hidden lg:block z-30 font-mono text-[10px] text-right transition-all duration-1000 ease-out ${
          isLoaded ? 'opacity-50' : 'opacity-0'
        }`}
        style={{ transitionDelay: '800ms' }}
      >
