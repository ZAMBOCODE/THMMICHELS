    ...
    <div className="pt-24 pb-16 md:pt-32 md:pb-24 bg-[#0F0F0F] min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mt-16 pt-10 border-t border-white/10 text-center">
          ...
          <Link
            to="/kontakt"
            className="btn-press inline-block bg-[#D97706] hover:bg-[#B45309] text-white px-8 py-4 font-black text-sm uppercase tracking-widest transition-[background-color,transform] duration-300"
          >
